						...
						<tbody>
							...
							<c:forEach items="${stuList}" var="data">
								<tr>
									...
									<td>${data.id}</td>
									<td>${data.name}</td>
									<td><c:forEach items="${data.stuCourse}" var="stuCourse">${stuCourse},</c:forEach></td>

									<td><a href="/StudentRegistrationCRUD/seeMore/${data.id}"><button
